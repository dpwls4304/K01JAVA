...
public class E01JunsuType {
	...
	public static void main(String[] args) {
			...
			System.out.println("int1 + int2 = "+ result1);//결과300
			...
			-byte, short형은 게임캐릭터의 움직임 표현이나 음원정보등을 저장할 때
			사용한다.
			 */
			...
			/*
			 ...
			 손실이 있기 때문)
			 -단byte와 short는 예외적인 상황으로 생각하면 된다. (int형 연산을
			 좋아하는 CPU의 특성) 
			 */
			...
			long long4 = 2200000000l;/*
				...
				간주하기 때문에 위 정수를 메모리에 올리는 순간 에러가 발생한다.
				이 때는 접미사(L or l)을 붙여서 int형 자료가 아닌
				long형 자료라는 것을 알려줘야 에러가 발생하지 않는다.
