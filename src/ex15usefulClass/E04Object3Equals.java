...
class MyClass {
	...
	/*
	 ...
	 객체가 가지고 있는 메버변수의 비교를 통해 동일여부를 판단한다.
	 */
	@Override
...
class Point {
	...
	/*
	 객체1, 2의 x,y값을 동시에 비교해서 둘 다 동일항 때 같은 객체로
	 판단하도록 오버라이딩 처리
	 */
	@Override
	public boolean equals(Object obj) {
...
public class E04Object3Equals {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 실행 될 때 자동으로 호출하므로, 아래 출력결과는 동일하다.
		 */
		System.out.println("pos1.toString()=>" + pos1.toString());
		System.out.println("pos1.toString()=>" + pos2.toString());
