...
public class E05LocalDateTimeO {
	...
	public static void main(String[] args) {
		...
		//특정 날짜와 시간
		LocalDateTime ofDateTime = LocalDateTime.of(2012, 4, 3, 4, 
		58, 32);
		...
		.with(TemporalAdjusters.dayOfWeekInMonth(4,
		DayOfWeek.SUNDAY));
		...
		System.out.println("2020년 3월 기준, 첫 번째 일요일 : " +
		first12Sunday);
		...
		System.out.println("클래스 실행 시간 확인(두 시간의 차) : " +
		duration.toMillis());
