...
접근지정자를 붙일 수 있는 곳
	클래스, 멤버변수, 멤버메소드 모두 가능하다
	class명 옆에는 public과 default만 붙일 수 있다.
 */
...
public class E01AccessModifierMain {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 ※private으로 선언된 멤버를 외부클래스에서 접근할떄는 주로
		...
		//System.out.println("two.privateVar=" + two.defaultVar);//에러발생
