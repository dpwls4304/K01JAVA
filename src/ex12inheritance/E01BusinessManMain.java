...
/*
 상속(Inheritance)
 	...
 	클래스를 정의하는 것을 말한다.
 	부모클래스를 자식클래스가 상속할 때는 extends 키워드를
 	사용한다.
 */
...
class BusinessMan extends Man {
	...
	public void tellYourInfo() {
		...
		//부모클래스에 정의된 멤버메소드호출. 상속받았으므로 호출 가능함.
		tellYourName();
	}
