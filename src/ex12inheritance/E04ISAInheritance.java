...
class Computer {
	...
	/*
	 ...
	 선언된 메소드를 통해서 간접 호출을 해아한다.
	 상속관계라면 protected로 선언된 메소드로 호출 할 수 있다.
	 */
...
/*
 컴퓨터를 상속한 노트북컴퓨터
 	: 컴퓨터가 가지고있는 기본기능에 휴대이용 부분을 확장하여 정의하였음.
 	휴대이용을 위해 배터라 멤버변수가 추가됨.
 */
class NotebookComputer extends Computer {
	...
	public NotebookComputer(String name, int initCharge) {
		super(name); //부모생성자를 항상 먼저 호출해야함. 아래거랑 순서 변경X
		//Q : super를 생략 불가능한 이유?
		battary = initCharge;
	}
