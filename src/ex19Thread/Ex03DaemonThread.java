...
/*
	...
	작업을 진행할 수 있다. 즉 동시에 작업을 진행할 수 없다.
 */
class NotThread {
	String title;
...
/*
 독립쓰레드(Non Daemon Thread)
 	...
 	일컫는다 것으로 메인쓰레드가 종료되어도 계속 실행되며, Dead
...
class YesThread extends Thread {
	public YesThread() {}
	/*
	 Thread클래스의 생성자를 호출할 때 전달하는 매개변수를
...
/*
 종속쓰레드(Daemon Thread)
 	...
 	등의 업무를 처리한다.
 	프로그램이 종료될 때 자동으로 종료되므로 주로 무한루프로
...
public class Ex03DaemonThread {
	...
	public static void main(String[] args) {
		...
		yt1.setName("첫번째쓰레드");//쓰레드의 이름을 지정하는 두 번째 방법
