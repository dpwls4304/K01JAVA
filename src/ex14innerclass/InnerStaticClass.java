...
class OuterClass {
	...
	void outerMemberMethod() {
		/*
		 ...
		 접근할 수 있다.(Heap영역에서는 Method영역을 참조 할 수 있다.)
		 */
	...
	static void outerStaticMethod() {
		...
		/*
		 ...
		 접근 할 수 있다.(Method 영역에서는 Heap영역을 참조할 수 없다.)
		 */
...
public class InnerStaticClass {
	...
	public static void main(String[] args) {
		...
		/*
		 외부클래스가 아닌 다른 클래스에서 접근 할 때의 방법은 아래와 같다.
		 */
		...
		/*
		 내부정적 클래스의 인스턴스멤버에 접근할때는 객체를 생성한 후
		 참조변수를 통해서 접근해야 한다.
		 */
		...
		/*
		 ...
		 외부클래스이 맴버변수(메소드)는 객체생성 후 참조변수를 통해
		 접근한다.
		 */
