...
class FriendInfoHandler {
	...
	/*
	 ...
	 모두 저장 할 수 있으므로, 하나의 배열내에 2개의 객체를
	 동시에 저장하여 관리 할 수 있다.
	 */
	private Friend[] myFriends;
	private int numOfFriends; //친구정보를 추가 할 때 +1 증가
	...
	/*
	 ...
	 3. 객체배열에 저장된 객체들을 for문을 통해 순차적으로 출력
	 	...
	 	정보를 출력 할 수 있음.(참조변수의 타입에 영향을 받지 않음.)
	 */
