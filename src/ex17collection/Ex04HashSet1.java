...
public class Ex04HashSet1 {
	...
	public static void main(String[] args) {
		...
		String strObjcect2 = new String("KOSMO61기");
		...
		/*
		 5-1] 기본 클래스형 객체 중복저장
		 	...
		 	중복이 제거된다. 따라서 아래의경우는 false가
		 	반환된다.
		 */
		System.out.println(set.add(strObjcect2) ? "저장성공" : "저장실패");
		...
		//1-8] 삭제
		System.out.println(set.remove(strObjcect2) ?
