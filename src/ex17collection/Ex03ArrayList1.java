...
/*
 ArrayList : List계역의 컬렉션으로
 	-데이터의 중복 저장이 허용된다.
 	-데이터의 저장 순서를 보장한다
 	-데이터에 접근할 때 iterator() 혹은 get()을
 		이용한다.
...
public class Ex03ArrayList1 {
	...
	public static void main(String[] args) {
		...
		list.add("트와이스");
		list.add(3, "워너원");
		//list.add(5, "소방차");//에러발생, 인덱스는 건너 뛸 수 없다.
		list.add(list.size(), "오마이걸");//<- 4번 인덱스에 저장됨.
