...
=> 기존Object기반의 FruitBox를 아래와 같이 제네릭 클래스로 정의한다.
자료형에 해당하는 부분을 대표문자 T(Type)으로 교체하고, 객체생성시
자료형을 결저하기 위해 "클래스명<T>" 형태로 변경한다.
 */
...
public class Ex02GenericClass {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 각각Apple, Banner 객체를 저장할 수 있는 인스턴스가
		 생성되었다.
		 */
		...
		GenericFruitBox<Banner> bannerBox = 
				new GenericFruitBox<Banner>();
		...
		/*
		 ...
		 컴파일 에러가 발생되므로 자료형에는 안전한 코드가 된다.
		 */
