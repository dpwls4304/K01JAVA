...
public class E05For {
	...
	public static void main(String[] args) {
		...
		total = 0;
		for(int i=0; i<=10; i+=2) { //증감연산자대신 복합대입연산자도 사용가능.
			total += 1;
		}
...
//		}
		...
		for(int dan=2 ; dan<=9; dan++) {
			for(int su=1 ; su<=9 ; su++) {
				...
				System.out.printf("%d X %d = %-2d%n", dan, su, dan*su);
