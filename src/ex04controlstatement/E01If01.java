...
public class E01If01 {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		 System.in.read()
		 	: 사용자에게 하나의 문자를 입력받을 때 사용하는 메소드로
		 	입력한 문자의 아스키코드값을 반환한다.
		 	해당 함수는 IOException을 기본적으로 가지고있어
		 	이를 무시하기 위해 main()함수에서 throws 처리를 해준다.
		 */
//		System.out.print("하나의 문자를 입력하세요:");
//		int asciiCode = System.in.read();
//		System.out.println("입력할문자:" + asciiCode);
//		System.out.println("입력할문자:" + (char)asciiCode);
		...
		/*
		 ...
		 '0' => 48
		 '9' => 57 이므로 해당 구간안에 있다면 숫자로 판단 할 수 있다.
